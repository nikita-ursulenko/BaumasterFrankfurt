...
<section id="hero" class="pt-16 bg-cover bg-center bg-no-repeat relative min-h-screen flex items-center"
    style="background-image: url('/assets/images/preview/portfolio.webp'); background-size: cover; background-position: center center; background-attachment: scroll; -webkit-background-size: cover;">
...
<section class="py-8 bg-white border-b">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-wrap justify-center gap-4">
            <button
                class="filter-btn active px-6 py-2 rounded-full border-2 border-accent-blue text-accent-blue font-medium hover:bg-accent-blue hover:text-white transition-colors"
                data-filter="all">
                Alle Projekte
            </button>
            <button
                class="filter-btn px-6 py-2 rounded-full border-2 border-gray-300 text-text-secondary hover:border-accent-blue hover:text-accent-blue transition-colors"
                data-filter="apartment">
                Wohnungen
            </button>
            <button
                class="filter-btn px-6 py-2 rounded-full border-2 border-gray-300 text-text-secondary hover:border-accent-blue hover:text-accent-blue transition-colors"
                data-filter="bathroom">
                Badezimmer
            </button>
            <button
                class="filter-btn px-6 py-2 rounded-full border-2 border-gray-300 text-text-secondary hover:border-accent-blue hover:text-accent-blue transition-colors"
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center process-step">
                <div
                    class="w-20 h-20 bg-accent-blue text-white rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p class="text-text-secondary">Wir besprechen Details, erstellen einen Arbeitsplan, wählen Materialien
                    aus und vereinbaren Termine.</p>
            </div>
            ...
            <div class="text-center process-step">
                ...
                <p class="text-text-secondary">Abbruch alter Beschichtungen, Oberflächenvorbereitung, Schutz von Möbeln
                    und Interieur.</p>
            </div>
            ...
            <div class="text-center process-step">
                ...
                <p class="text-text-secondary">Hauptarbeiten: Montage, Veredelung, Malerei. Regelmäßige
                    Qualitätskontrolle in jeder Phase.</p>
            </div>
            ...
            <div class="text-center process-step">
                ...
                <p class="text-text-secondary">Endreinigung, Qualitätsprüfung, Beseitigung kleiner Mängel und feierliche
                    Objektübergabe.</p>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-white">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
            Lassen Sie uns Ihr Projekt besprechen und ein einzigartiges Raumkonzept unter Berücksichtigung aller Wünsche
            ...
            <div class="p-6">
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-8 py-2">
                    ...
                    <div class="project-info-card">
                        <div class="project-info-header">
                            ...
                            <h3 class="project-info-title">Projektinformationen</h3>
                        </div>
                        <div class="project-info-content">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value">${new Date(project.completion_date).toLocaleDateString('de-DE')}</div>
                            </div>
                            ` : ''}
                            ${project.client_name ? `
                            <div class="info-item">
                                ...
                                <div class="info-value">${translateToGerman(project.client_name)}</div>
                            </div>
                            ` : ''}
                            ${project.location ? `
                            <div class="info-item">
                                ...
                                <div class="info-value">${translateToGerman(project.location)}</div>
                            </div>
                            ` : ''}
                        </div>
                    </div>
                    ...
                    <div class="project-description-card">
                        <div class="project-description-header">
                            ...
                            <h3 class="project-description-title">Projektbeschreibung</h3>
                        </div>
                        <div class="project-description-content">
                            <p class="description-text">${translateToGerman(project.description)}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <div class="project-info-card">
                        <div class="project-info-header">
                            ...
                            <h3 class="project-info-title">Technische Details</h3>
                        </div>
                        <div class="project-info-content">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value">${translateToGerman(project.technical_info.style)}</div>
                            </div>
                            ` : ''}
                        </div>
                        ...
                        project.technical_info.features.map(feature =>
                            `<span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs rounded-full border border-blue-200 hover:bg-blue-100 transition-colors">${translateToGerman(feature.trim())}</span>`
                        ).join('') :
                ...
                <div class="mb-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <h4 class="font-medium mb-2 text-center">Vorher</h4>
                            <img src="${project.before_after.before}" alt="Vor der Renovierung" class="w-full h-48 object-cover rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer" onclick="openImageModal('${project.before_after.before}')">
                        </div>
                        ` : ''}
                        ${project.before_after.after ? `
                        <div>
                            <h4 class="font-medium mb-2 text-center">Nachher</h4>
                            <img src="${project.before_after.after}" alt="Nach der Renovierung" class="w-full h-48 object-cover rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer" onclick="openImageModal('${project.before_after.after}')">
                        </div>
                        ` : ''}
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        ${project.gallery.map(image => `
                            <img src="${image}" alt="Galerie" class="w-full h-32 object-cover rounded-lg cursor-pointer hover:opacity-75 transition-all duration-300 hover:scale-105" onclick="openImageModal('${image}')">
                        `).join('')}
                    </div>
                </div>
                ` : ''}
        ...
        <div class="bg-white rounded-lg max-w-6xl mx-auto max-h-[95vh] overflow-y-auto">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ${project.gallery.map(image => `
                        <img src="${image}" alt="Galerie" class="w-full h-48 object-cover rounded-lg cursor-pointer hover:opacity-75 transition-all duration-300 hover:scale-105" onclick="openImageModal('${image}')">
                    `).join('')}
                </div>
            </div>
        </div>
