...
<section id="hero" class="pt-16 bg-cover bg-center bg-no-repeat relative min-h-screen flex items-center"
    style="background-image: url('/assets/images/preview/FAQ.webp'); background-size: cover; background-position: center center; background-attachment: scroll; -webkit-background-size: cover;">
...
<style>
    ...
    .blog-card:hover .font-semibold,
    .faq-item:hover .font-semibold,
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white p-6 rounded-lg shadow-lg tips-card">
                ...
                <p class="text-text-secondary mb-4">
                    Wie Sie den Raum richtig auf den Beginn der Arbeiten vorbereiten und was Sie im Voraus
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg tips-card">
                ...
                <p class="text-text-secondary mb-4">
                    Worauf Sie bei der Abnahme der Arbeiten achten sollten und wie Sie die Ausführungsqualität
                    überprüfen.
                </p>
                <ul class="text-sm text-text-secondary space-y-1">
                    ...
                    <article
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="font-semibold text-xl text-text-primary mb-3">
                                <a href="blog_post?slug=<?php echo htmlspecialchars($post['slug']); ?>"
...
<section class="py-20 bg-premium-gray">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 text-center">
        <h2 id="contact-title"
            class="font-montserrat font-semibold text-3xl lg:text-4xl text-text-primary mb-6 fade-in-up">
