    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-20 relative z-10">
        <div class="text-center">
            <h1 id="hero-title"
                ...
                <?php
                $title = 'Über das Unternehmen Frankfurt Innenausbau';
                $words = explode(' ', $title);
            ...
            <p id="hero-subtitle"
                ...
                Unsere Mission ist es, Ihre Ideen mit Premium-Qualität und Aufmerksamkeit für Details in die Realität
                umzusetzen.
            </p>
        </div>
    </div>
...
<style>
    ...
    .card .font-semibold,
    .team-member .font-semibold,
    .feature-item .font-semibold {
        transition: all 0.3s ease;
    }

    .card:hover .font-semibold,
    .team-member:hover .font-semibold,
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <?php else: ?>
                    <p class="text-lg text-text-secondary mb-6 leading-relaxed">
                        ...
                        die beschlossen haben, ihr Wissen und ihre Fähigkeiten zu vereinen, um qualitativ hochwertige
                        Dienstleistungen
                        im Bereich Innenarbeiten anzubieten.
                    </p>
                    <p class="text-lg text-text-secondary mb-6 leading-relaxed">
                        In 10 Jahren Arbeit haben wir mehr als 500 Projekte unterschiedlicher Komplexität durchgeführt — von
                        kleinen
                        kosmetischen Reparaturen bis hin zur vollständigen Rekonstruktion von Wohnungen und Büros. Unsere
                        Erfahrung
            ...
            <div class="relative">
                <?php if (!empty($about_data['history']['image'])): ?>
                    <img src="../<?php echo htmlspecialchars($about_data['history']['image']); ?>" alt="Teamfoto"
            ...
            <?php if (!empty($team_members)): ?>
                <?php foreach ($team_members as $index => $member): ?>
                    <div class="text-center team-member fade-in-up" style="animation-delay: <?php echo ($index * 0.2); ?>s;">
                        <div
                            class="w-32 h-32 bg-gray-200 rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden">
                            <?php if (!empty($member['image'])): ?>
                                <img src="../<?php echo htmlspecialchars($member['image']); ?>"
                                    alt="<?php echo htmlspecialchars($member['name']); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                                <?php
                                $initials = '';
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0s;">
                <div
                    class="w-16 h-16 bg-accent-blue text-white rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p class="text-text-secondary">Wir verwenden nur bewährte Materialien und moderne Technologien. Jedes
                    Detail ist wichtig.</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0.2s;">
                ...
                <p class="text-text-secondary">Wir halten die vereinbarten Termine ein. Ihre Zeit ist für uns genauso
                    wertvoll wie unsere für Sie.</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0.4s;">
                ...
                <p class="text-text-secondary">Jedes Projekt ist einzigartig. Wir berücksichtigen Ihre Wünsche und die
                    Besonderheiten des Objekts.</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0.6s;">
                ...
                <p class="text-text-secondary">Keine versteckten Zusatzkosten. Der Preis im Vertrag bleibt bis zum
                    Abschluss der Arbeiten unverändert.</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0.8s;">
                ...
                <p class="text-text-secondary">Wir bieten erweiterte Garantie auf alle Arten von Arbeiten. Wir sind von
                    der Qualität unserer Arbeit überzeugt.</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 1.0s;">
                ...
                <p class="text-text-secondary">Wir halten Sie über alle Arbeitsphasen auf dem Laufenden. Wir sind immer
                    bereit, Ihre Fragen zu beantworten.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-white">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
            Vertrauen Sie Ihre Renovierung einem Team mit Erfahrung und Reputation an. Erhalten Sie noch heute eine
            kostenlose Beratung.
        </p>
