...
<section id="hero" class="pt-16 bg-cover bg-center bg-no-repeat relative min-h-screen flex items-center"
    style="background-image: url('/assets/images/preview/services.webp'); background-size: cover; background-position: center center; background-attachment: scroll; -webkit-background-size: cover;">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-20 relative z-10">
        <div class="text-center">
            <h1 id="hero-title"
                ...
                <?php
                $title = $seo['h1'] ?? 'Unsere Dienstleistungen';
                $words = explode(' ', $title);
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center process-step-animate" data-delay="0">
                ...
                <p class="text-text-secondary">Hinterlassen Sie eine Anfrage auf der Website oder rufen Sie uns an. Wir
                    antworten innerhalb von 15 Minuten.</p>
            </div>
            <div class="text-center process-step-animate" data-delay="0.4">
                ...
                <p class="text-text-secondary">Wir kommen zum Objekt, nehmen Maß und erstellen eine detaillierte
                    Kostenvoranschlag. Kostenlos.</p>
            </div>
            <div class="text-center process-step-animate" data-delay="0.8">
                ...
                <p class="text-text-secondary">Wir schließen einen Vertrag mit festen Preisen und Ausführungsfristen ab.
                </p>
            </div>
            <div class="text-center process-step-animate" data-delay="1.2">
                ...
                <p class="text-text-secondary">Wir führen die Arbeiten termingerecht aus, räumen auf und übergeben das
                    Objekt schlüsselfertig.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="text-center mt-12">
            <p class="text-text-secondary mb-6">Benötigen Sie eine individuelle Kostenvoranschlag? Hinterlassen Sie eine
                Anfrage und erhalten Sie eine kostenlose Berechnung!</p>
            <?php render_frontend_button([
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="service-info-card">
                        <div class="service-info-header">
                            ...
                            <h3 class="service-info-title">Service-Informationen</h3>
                        </div>
                        <div class="service-info-content">
                            <div class="info-item">
                                ...
                                <div class="info-value">${service.category || 'Nicht angegeben'}</div>
                            </div>
                            ${service.price ? `
                            <div class="info-item">
                                <div class="info-label">
                                ...
                                <div class="info-value price-value">ab ${service.price} €</div>
                            </div>
                            ` : ''}
                            <div class="info-item">
                                <div class="info-label">
                    ...
                    <div class="service-description-card">
                        <div class="service-description-header">
                            ...
                            <h3 class="service-description-title">Service-Beschreibung</h3>
                        </div>
