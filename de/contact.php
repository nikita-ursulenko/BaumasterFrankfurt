 ...
 * Baumaster Frontend - Contact Page (German)
 */
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="text-center">
                ...
                <h3 class="font-semibold text-base text-text-primary mb-1">Telefon</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="font-semibold text-base text-text-primary mb-1">Adresse</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="font-semibold text-base text-text-primary mb-1">Arbeitszeiten</h3>
        ...
        <div class="grid lg:grid-cols-2 gap-16">
            ...
            <div>
                ...
                <p class="text-lg text-text-secondary mb-8">
                    Füllen Sie das Formular aus, und wir melden uns innerhalb von 15 Minuten bei Ihnen, um die Details Ihres Projekts zu besprechen.
                </p>
            ...
            <div class="space-y-8">
                <div>
                    <h3 class="font-semibold text-2xl text-text-primary mb-6">Schnelle Kommunikation</h3>
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg">
                    <h4 class="font-semibold text-xl text-text-primary mb-4">Vorteile der Zusammenarbeit mit uns</h4>
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            <svg class="h-5 w-5 text-green-500 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-text-secondary">Kostenloser Besuch des Meisters zur Vermessung</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-5 w-5 text-green-500 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-text-secondary">Feste Preise im Vertrag</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-5 w-5 text-green-500 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-text-secondary">Garantie auf alle Arten von Arbeiten</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-5 w-5 text-green-500 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-text-secondary">Einhaltung der vertraglichen Fristen</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="h-5 w-5 text-green-500 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-text-secondary">Reinigung nach Abschluss der Arbeiten</span>
                        </li>
                    </ul>
                </div>
                
                <div class="bg-accent-blue text-white p-8 rounded-lg">
                    <h4 class="font-semibold text-xl mb-4">Notfallreparatur</h4>
                    <p class="mb-4">Benötigen Sie eine dringende Reparatur? Wir arbeiten an Wochenenden und Feiertagen.</p>
                    <?php render_frontend_button([
                        'text' => 'Meister rufen',
                        'variant' => 'secondary',
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="font-montserrat font-semibold text-3xl lg:text-4xl text-text-primary mb-4">
                Wir arbeiten in ganz Frankfurt
            </h2>
            <p class="text-xl text-text-secondary max-w-3xl mx-auto">
                Wir führen Projekte in allen Stadtteilen und Vororten durch
            </p>
        </div>
        ...
        <div class="relative">
            ...
            <div id="map-overlay" class="absolute inset-0 bg-black bg-opacity-20 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-opacity-30">
                <div class="text-center">
                    ...
                    <p class="text-white text-sm drop-shadow-md font-medium">Klicken Sie, um die Karte zu aktivieren</p>
                </div>
            </div>
            ...
            function initializeMap() {
                ...
                mainMarker.bindPopup(`
                    <div class="text-center">
                        ...
                        <p class="text-xs text-gray-500">Wir arbeiten in der ganzen Stadt</p>
                    </div>
                `);
                
                // Координаты районов Франкфурта
                districtsData = [
                    { name: 'Altstadt', coords: [50.1109, 8.6821], description: 'Historisches Zentrum' },
                    { name: 'Sachsenhausen', coords: [50.1036, 8.6908], description: 'Südlicher Bezirk' },
                    { name: 'Westend', coords: [50.1200, 8.6500], description: 'Westlicher Bezirk' },
                    { name: 'Nordend', coords: [50.1300, 8.6800], description: 'Nördlicher Bezirk' },
                    { name: 'Ostend', coords: [50.1150, 8.7200], description: 'Östlicher Bezirk' },
                    { name: 'Bornheim', coords: [50.1250, 8.7100], description: 'Wohnbezirk' },
                    { name: 'Bockenheim', coords: [50.1200, 8.6400], description: 'Universitätsbezirk' },
                    { name: 'Gallus', coords: [50.1000, 8.6500], description: 'Industriebezirk' },
                    { name: 'Höchst', coords: [50.0900, 8.5500], description: 'Westlicher Vorort' },
                    { name: 'Fechenheim', coords: [50.1300, 8.7500], description: 'Östlicher Vorort' },
                    { name: 'Rödelheim', coords: [50.1100, 8.6000], description: 'Westlicher Vorort' }
                ];
        ...
        <!-- Districts -->
        <div class="mt-12">
            <h3 class="text-center font-semibold text-xl text-text-primary mb-8">Arbeitsbezirke</h3>
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 text-center">
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Altstadt')">
                    ...
                    <div class="text-xs text-gray-500">Historisches Zentrum</div>
                </div>
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Sachsenhausen')">
                    ...
                    <div class="text-xs text-gray-500">Südlicher Bezirk</div>
                </div>
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Westend')">
                    ...
                    <div class="text-xs text-gray-500">Westlicher Bezirk</div>
                </div>
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Nordend')">
                    ...
                    <div class="text-xs text-gray-500">Nördlicher Bezirk</div>
                </div>
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Ostend')">
                    ...
                    <div class="text-xs text-gray-500">Östlicher Bezirk</div>
                </div>
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Bornheim')">
                    ...
                    <div class="text-xs text-gray-500">Wohnbezirk</div>
                </div>
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Bockenheim')">
                    ...
                    <div class="text-xs text-gray-500">Universitätsbezirk</div>
                </div>
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Gallus')">
                    ...
                    <div class="text-xs text-gray-500">Industriebezirk</div>
                </div>
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Höchst')">
                    ...
                    <div class="text-xs text-gray-500">Westlicher Vorort</div>
                </div>
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showDistrictOnMap('Fechenheim')">
                    ...
                    <div class="text-xs text-gray-500">Östlicher Vorort</div>
                </div>
                ...
                <div class="bg-gray-50 p-3 rounded hover:bg-accent-blue hover:text-white transition-colors cursor-pointer" onclick="showAllDistricts()">
                    <div class="font-medium">Und andere</div>
                    <div class="text-xs text-gray-500">Alle Bezirke</div>
                </div>
            </div>
        </div>
    </div>
