    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center process-step">
                ...
                <p class="text-text-secondary">Обсуждаем детали, создаём план работ, выбираем материалы и согласовываем
                    сроки.</p>
            </div>
            ...
            <div class="text-center process-step">
                ...
                <p class="text-text-secondary">Демонтаж старых покрытий, подготовка поверхностей, защита мебели и
                    интерьера.</p>
            </div>
            ...
            <div class="text-center process-step">
                ...
                <p class="text-text-secondary">Основные работы: монтаж, отделка, покраска. Регулярный контроль качества
                    на каждом этапе.</p>
            </div>
            ...
            <div class="text-center process-step">
                ...
                <p class="text-text-secondary">Финальная уборка, проверка качества, устранение мелких недочётов и
                    торжественная сдача объекта.</p>
            </div>
        </div>
    </div>
</section>
