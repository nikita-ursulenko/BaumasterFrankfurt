        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative">
                <?php if (!empty($about_data['history']['image'])): ?>
                    <img src="<?php echo htmlspecialchars($about_data['history']['image']); ?>" alt="Фото команды"
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0s;">
                ...
                <p class="text-text-secondary">Используем только проверенные материалы и современные технологии. Каждая
                    деталь важна.</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0.2s;">
                ...
                <p class="text-text-secondary">Соблюдаем договорные сроки. Ваше время ценно для нас, как и наше для вас.
                </p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0.4s;">
                ...
                <p class="text-text-secondary">Каждый проект уникален. Учитываем ваши пожелания и особенности объекта.
                </p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0.6s;">
                ...
                <p class="text-text-secondary">Никаких скрытых доплат. Цена в договоре остается неизменной до завершения
                    работ.</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 0.8s;">
                ...
                <p class="text-text-secondary">Предоставляем расширенную гарантию на все виды работ. Уверены в качестве
                    нашей работы.</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg text-center feature-item fade-in-up" style="animation-delay: 1.0s;">
                ...
                <p class="text-text-secondary">Держим вас в курсе всех этапов работы. Всегда готовы ответить на ваши
                    вопросы.</p>
            </div>
        </div>
    </div>
